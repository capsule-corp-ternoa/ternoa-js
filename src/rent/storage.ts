...
export const getRentalContractData = async (nftId: number): Promise<RentalContractDataType | null> => {
  ...
  try {
    ...
    return {
      ...
      rentFeeValue,
      rentFeeValueRounded,
      renterCancellationFee: renterCancellationFeeType,
      renterCancellationFeeValue,
      renterCancellationFeeValueRounded,
      renteeCancellationFee: renteeCancellationFeeType,
      renteeCancellationFeeValue,
      renteeCancellationFeeValueRounded,
