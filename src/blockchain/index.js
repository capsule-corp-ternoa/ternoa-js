...
exports.unFormatBalance = exports.formatBalance = exports.isValidSignature = exports.isValidAddress = exports.batchAllTxHex = exports.batchAllTx = exports.batchTxHex = exports.batchTx = exports.runTx = exports.submitTx = exports.signTx = exports.createTxHex = exports.checkTxAvailable = exports.isTransactionSuccess = exports.consts = exports.query = exports.safeDisconnect = exports.getApiEndpoint = exports.isApiConnected = exports.getRawApi = exports.changeEndpoint = void 0;
 ...
 */
const signTx = async (keyring, txHex) => {
    const api = await (0, exports.getRawApi)();
 ...
 */
const runTx = async (txPallet, txExtrinsic, txArgs, keyring, callback) => {
    const signableTx = await (0, exports.createTxHex)(txPallet, txExtrinsic, txArgs);
    if (!keyring)
        return signableTx;
    const signedTx = await (0, exports.signTx)(keyring, signableTx);
    return await (0, exports.submitTx)(signedTx, callback);
};
exports.runTx = runTx;
/**
 * @name batchTx
 ...
 */
const formatBalance = async (input, withSi = true, withSiFull = false, withUnit = true, unit = "CAPS") => {
    const api = await (0, exports.getRawApi)();
    const decimals = api.registry.chainDecimals[0];
    util_1.formatBalance.setDefaults({ decimals, unit });
    return (0, util_1.formatBalance)(input, { withSi, withSiFull, withUnit });
};
