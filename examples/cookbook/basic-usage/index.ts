...
import { createCollection, createNftTx, getCollectionData, getCollectionSizeLimit, getNftMintFee, getNextCollectionId, getNextNftId, getNftData } from '../../../src/nft/index';
...
async function main() {
    ...
    const data = await getNftMintFee();
    if (data == null) {
